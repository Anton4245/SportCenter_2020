package ru.sport_center.ui.customviews
...
import ru.sport_center.common.getColorRes
...
class ColorPickerView : LinearLayout {
    ...
    var onColorClickListener: (color: Order.Color) -> Unit = { }
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        ...
        Order.Color.values().forEach { color ->
            addView(
                ColorCircleView(context).apply {
                    ...
                    setOnClickListener { onColorClickListener(it.tag as Order.Color) }
                })
        }
